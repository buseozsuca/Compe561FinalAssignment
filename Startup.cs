    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                   name: "mangadetails",
                   template: "Manga/Details/{mangaId?}",
                   defaults: new { Controller = "Manga", action = "Details"});

                routes.MapRoute(
                    name: "categoryfilter",
                    template: "Manga/{action}/{category?}",
